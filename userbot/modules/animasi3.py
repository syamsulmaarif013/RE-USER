...
async def koc(e):
    if not e.text[0].isalpha() and e.text[0] not in ("/", "#", "@", "!"):
        ...
        await e.edit("KAMU")
        await e.edit("AKU CINTA KAMU")
        await e.edit("MY HONEY SWEETY")
        await e.edit("💕💞💘💝")
        await e.edit("💘💕💞💝")
        await e.edit("SAYANG KAMU MWAH💞")
...
async def typewriter(typew):
    ...
    await typew.edit("`🏃     🦖`")
    await typew.edit("`🏃    🦖`")
    await typew.edit("`UDAHLAH CAPE, MATI AJA`")
    sleep(1)
    await typew.edit("`🧎🦖`")
    sleep(2)
...
async def typewriter(typew):
    typew.pattern_match.group(1)
    sleep(1)
    await typew.edit("`Hai, AKU CINTA KAMU 💞`")
    sleep(1)
    await typew.edit("`AKU CINTA KAMU BANGET!`")
    sleep(1)
    await typew.edit("`AKU BUTUH KAMU BUAT LENGKAPIN HIDUPKU!`")
    sleep(1)
    await typew.edit("`HIDUPKU TANPA KAMU HAMPA TAK BERARTI!`")
    sleep(1)
    await typew.edit("`JADILAH BELAHAN JIWAKU💕💗`")
    sleep(1)
    await typew.edit("`JADILAH SUMBER BAHAGIAKU💗💞`")
    sleep(1)
    await typew.edit("`JADILAH SUMBER SENYUMKU💝💗`")
    sleep(1)
    await typew.edit("`AKU SAYANG KAMU BANGET💟💖`")
    sleep(1)
    await typew.edit("`AKU CINTA KAMU BANGET💘💓`")
    sleep(1)
