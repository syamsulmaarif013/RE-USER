...
async def _(event):
    ...
    async with bot.conversation(chat) as conv:
        await asyncio.sleep(2)
        await event.edit("`Agii donglot bentar yaa suu...`")
        try:
...
async def _(event):
    ...
    strings = {
        ...
        "processing": "`Agi donglottt asu....`",
        "uploading": "`Bentar aplod neeeh.....`",
    }
