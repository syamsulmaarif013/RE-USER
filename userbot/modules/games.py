...
CMD_HELP.update({
    "games": "\
`.xogame`\
\nUsage: Game XOXO Pokoknya.\
\n\n`.mod <nama app>`\
\nUsage: Dapatkan Aplikasi Mod , Bukan Untuk Aplikasi Bokep\
\n\n`.wp <teks> <username/ID>`\
\nUsage: Berikan Pesan Rahasia Kepada Pengguna Lain"})
